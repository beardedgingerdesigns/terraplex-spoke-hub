...
- [component-library/product-block/research/refero-0dea72da-product-data-passport.md](component-library/product-block/research/refero-0dea72da-product-data-passport.md) — single-page product data-passport / dossier: hairline-rule grid divides one printable surface into identity + layered exploded anatomy diagram with A/B/C/D callouts + composition breakdown + applications chips + provenance world-map with flag pins + lifecycle impact band with everyday-unit equivalences + comparison bar charts vs reference + QR code corner; documentation register that complements the long-scroll [spec-sheet](component-library/product-block/research/refero-27715bc5-spec-sheet-product-block.md) (all 6 archetypes via per-archetype palette)
...
- [component-library/contact/research/refero-45feb3a4-live-chat-handoff.md](component-library/contact/research/refero-45feb3a4-live-chat-handoff.md) — live-chat handoff to a real human agent: centered question + body paragraph with explicit business-hours statement + single brand-color "Launch chat" CTA + 2-column reassurance band addressing the two failure modes ("can't chat now" + "outside hours") + floating chat-bubble launcher fallback; distinct from the AI assistant chat (humans, not bot) and the calendar-led rep card (now, not scheduled) (all archetypes via per-archetype palette)
