...
- [component-library/services/research/refero-d030e2b2-numbered-process-shopper.md](component-library/services/research/refero-d030e2b2-numbered-process-shopper.md) — process-led 3-step numbered timeline with connecting rule, ZIP localization band, multi-quote testimonial band on saturated brand-color, FAQ with smart-default expansion, mirrored closer signup band; for enrollment programs (Part 107 cohort, fleet-share, operator certification ladder) AND service-application / onboarding flows where the customer's hesitation is "what does this even involve?" (all archetypes)
