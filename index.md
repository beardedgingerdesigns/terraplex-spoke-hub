...
- [component-library/services/research/refero-29ece5fd-roi-calculator-projection.md](component-library/services/research/refero-29ece5fd-roi-calculator-projection.md) — two-pane ROI / savings-projection calculator: "tell us where you are today" input form on the left + "this is tomorrow" 4-metric grid + saturated brand-color anchor tile with one oversized projected-savings figure on the right + methodology-footnote band beneath; right pick when the dealer's blocked sale is dollar-cost objection vs. ground-rig / helicopter / manned-fixed-wing baselines (all archetypes; requires a defensible benchmark dataset)
