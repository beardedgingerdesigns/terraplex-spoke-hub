...
- [component-library/services/research/refero-d030e2b2-numbered-step-process.md](component-library/services/research/refero-d030e2b2-numbered-step-process.md) — process-led services with two hero variants (light contained service-application + saturated brand-color enrollment): 3-step horizontal numbered timeline with connecting rule + ZIP locator + "How it works" 3-up cards on dark band + optional 4-up benefits + multi-quote testimonial + FAQ with smart-default expansion + closer band; right pick when the customer's hesitation is "what does this even involve?" (all archetypes via per-archetype palette)
- [component-library/services/research/refero-638171bd-events-roadshow-landing.md](component-library/services/research/refero-638171bd-events-roadshow-landing.md) — events / roadshows / field-days landing: small label-shaped hero + asymmetric photo collage proof tile + notify-me CTA + explicit upcoming/past split with empty-state graceful fallback + flat past-events table (Event/Date/Location/Type pill) OR replay-card grid; for dealers with an active in-person event cadence (all 6 archetypes via per-archetype palette)
