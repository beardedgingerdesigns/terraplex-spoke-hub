...
- [component-library/services/research/refero-d030e2b2-numbered-step-process.md](component-library/services/research/refero-d030e2b2-numbered-step-process.md) — services pattern: 3-step horizontal numbered timeline with connecting rule, two registers — process-clarity (neutral two-column hero + photo card + ZIP locator + dark "How it works" 3-up + alternating bands; right pick when customer's hesitation is "what does this even involve?") and enrollment-led (brand-color hero + 3-step + ZIP localization + 4-up benefit cards with attribution + multi-quote testimonial on saturated brand-color + smart-default-expanded FAQ + closer signup band; right pick for recruitment programs like Part 107 cohort, fleet-share, operator certification ladder); merged from refero-d030e2b2-numbered-stepper-services + refero-d030e2b2-numbered-process-shopper (all archetypes)
