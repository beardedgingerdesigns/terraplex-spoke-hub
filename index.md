...
- [component-library/services/research/refero-d030e2b2-numbered-process-shopper.md](component-library/services/research/refero-d030e2b2-numbered-process-shopper.md) — enrollment-led services: brand-color hero + 3-step horizontal numbered process flow with connecting line + ZIP localization band + 4-up benefit cards with attribution + multi-quote testimonial band on saturated brand-color + FAQ with smart-default expansion + closer signup band; for recruitment programs (Part 107 cohort, fleet-share, operator certification ladder) (all archetypes)
